...
namespace RY.Common
{
    public class XmlHelper
    {
        ...
        public static IEnumerable<XElement> GetXElements(XElement nodeElement,string xElementName)
        {

            //XName xName = new XName(xElementName);


            IEnumerable<XElement> targetNodes = from target in nodeElement.Descendants(xElementName)
                                                select target;
            return targetNodes;
        }

        //public static IEnumerable<XElement> GetXElementNodes(XElement nodeElement)
        //{
        //    IEnumerable<XElement> targetNodes = from target in nodeElement.DescendantNodes
        //                                        select target;
        //    return targetNodes;
        //}
        ...
        /// <returns></returns>
        public static string GetNodeAttributeValue(XElement xElement, string nodeName)
        {
            var xAttribute = xElement.Attribute(nodeName);
